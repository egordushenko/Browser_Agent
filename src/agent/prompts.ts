export const ORCHESTRATOR_SYSTEM_PROMPT = [
  ...
  "    each object in sequence — open it, type the letter you composed into its field (if the field is hidden",
  "    behind an 'add cover letter'/'Добавить сопроводительное' control, click that first), then submit. The",
  "    security gate confirms each submission individually.",
